...
if [[ -d "/usr/share/elasticsearch/plugins/opendistro-performance-analyzer" ]]; then
    ...
    ES_JAVA_OPTS="-Djava.security.policy=file:///usr/share/elasticsearch/performance-analyzer-rca/pa_config/opensearch_security.policy -Dclk.tck=$CLK_TCK -Djdk.attach.allowAttachSelf=true $ES_JAVA_OPTS"
