...
public class MetricsModel {
  ...
  static {
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.CORES.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.OSMetrics.PAGING_MAJ_FLT_RATE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT_PER_SEC.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.OSMetrics.PAGING_MIN_FLT_RATE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT_PER_SEC.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.OSMetrics.PAGING_RSS.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.PAGES.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.OSMetrics.SCHED_RUNTIME.toString(),
        new MetricAttributes(
            AllMetrics.MetricUnits.SEC_PER_CONTEXT_SWITCH.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.BYTE_PER_SEC.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.SEC_PER_EVENT.toString(), AllMetrics.AggregatedOSDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.OSMetrics.THREAD_BLOCKED_EVENT.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.AggregatedOSDimension.values()));

    // Latency Metric
    allMetricsInitializer.put(
        AllMetrics.CommonMetric.LATENCY.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.LatencyDimension.values()));
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.HttpOnlyDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.BYTE.toString(), AllMetrics.CacheConfigDimension.values()));

    // Circuit Breaker Metrics
    allMetricsInitializer.put(
        AllMetrics.CircuitBreakerValue.CB_ESTIMATED_SIZE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.BYTE.toString(), AllMetrics.CircuitBreakerDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.CircuitBreakerValue.CB_CONFIGURED_SIZE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.BYTE.toString(), AllMetrics.CircuitBreakerDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.CircuitBreakerValue.CB_TRIPPED_EVENTS.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.CircuitBreakerDimension.values()));

    // Heap Metrics
    allMetricsInitializer.put(
        AllMetrics.HeapValue.GC_COLLECTION_EVENT.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.HeapDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.HeapValue.GC_COLLECTION_TIME.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.HeapDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.HeapValue.HEAP_COMMITTED.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.BYTE.toString(), AllMetrics.HeapDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.PERCENT.toString(), AllMetrics.DiskDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.DiskValue.DISK_WAITTIME.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.DiskDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.DiskValue.DISK_SERVICE_RATE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.MEGABYTE_PER_SEC.toString(), AllMetrics.DiskDimension.values()));

    // TCP Metrics
    allMetricsInitializer.put(
        AllMetrics.TCPValue.Net_TCP_NUM_FLOWS.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.TCPDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.TCPValue.Net_TCP_TXQ.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.SEGMENT_PER_FLOW.toString(), AllMetrics.TCPDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.BYTE_PER_FLOW.toString(), AllMetrics.TCPDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.PACKET_PER_SEC.toString(), AllMetrics.IPDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.BYTE_PER_SEC.toString(), AllMetrics.IPDimension.values()));

    // Thread Pool Metrics
    allMetricsInitializer.put(
        AllMetrics.ThreadPoolValue.THREADPOOL_QUEUE_SIZE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.ThreadPoolDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(
            AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.ShardStatsDerivedDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.ShardStatsValue.CACHE_QUERY_HIT.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.ShardStatsDerivedDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.ShardStatsValue.CACHE_QUERY_MISS.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.ShardStatsDerivedDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.ShardStatsValue.CACHE_QUERY_SIZE.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.BYTE.toString(), AllMetrics.ShardStatsDerivedDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.EmptyDimension.values()));

    allMetricsInitializer.put(
        AllMetrics.MasterMetricValues.MASTER_TASK_QUEUE_TIME.toString(),
        new MetricAttributes(
            AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.MasterMetricDimensions.values()));
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(
            AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.FaultDetectionDimension.values()));
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(
            AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.FaultDetectionDimension.values()));
    ...
    allMetricsInitializer.put(
            ...
            new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(),
                    AllMetrics.EmptyDimension.values()));

    allMetricsInitializer.put(
        AllMetrics.ShardStateValue.SHARD_STATE.toString(),
        new MetricAttributes(
            AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.ShardStateDimension.values()));

    allMetricsInitializer.put(
            AllMetrics.ClusterApplierServiceStatsValue.CLUSTER_APPLIER_SERVICE_LATENCY.toString(),
            new MetricAttributes(
                    AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.EmptyDimension.values()));

    allMetricsInitializer.put(
            AllMetrics.ClusterApplierServiceStatsValue.CLUSTER_APPLIER_SERVICE_FAILURE.toString(),
            new MetricAttributes(
                    AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.EmptyDimension.values()));
    
    allMetricsInitializer.put(
            AllMetrics.AdmissionControlValue.REJECTION_COUNT.toString(),
            new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.AdmissionControlDimension.values())
    );
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.COUNT.toString(), AllMetrics.ShardIndexingPressureDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.ShardIndexingPressureValue.CURRENT_BYTES.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.BYTE.toString(), AllMetrics.ShardIndexingPressureDimension.values()));
    allMetricsInitializer.put(
    ...
    allMetricsInitializer.put(
        ...
        new MetricAttributes(AllMetrics.MetricUnits.COUNT_PER_SEC.toString(), AllMetrics.ShardIndexingPressureDimension.values()));
    allMetricsInitializer.put(
        AllMetrics.ShardIndexingPressureValue.LAST_SUCCESSFUL_TIMESTAMP.toString(),
        new MetricAttributes(AllMetrics.MetricUnits.MILLISECOND.toString(), AllMetrics.ShardIndexingPressureDimension.values()));
