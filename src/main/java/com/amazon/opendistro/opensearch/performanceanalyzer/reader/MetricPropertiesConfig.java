...
public final class MetricPropertiesConfig {
  ...
  private MetricPropertiesConfig() {
    ...
    metricPathMap.put(AllMetrics.MetricName.CACHE_CONFIG, PerformanceAnalyzerMetrics.sCacheConfigPath);
    metricPathMap.put(AllMetrics.MetricName.CIRCUIT_BREAKER, PerformanceAnalyzerMetrics.sCircuitBreakerPath);
    metricPathMap.put(AllMetrics.MetricName.HEAP_METRICS, PerformanceAnalyzerMetrics.sHeapPath);
    metricPathMap.put(AllMetrics.MetricName.DISK_METRICS, PerformanceAnalyzerMetrics.sDisksPath);
    ...
    metricPathMap.put(AllMetrics.MetricName.THREAD_POOL, PerformanceAnalyzerMetrics.sThreadPoolPath);
    metricPathMap.put(AllMetrics.MetricName.SHARD_STATS, PerformanceAnalyzerMetrics.sIndicesPath);
    metricPathMap.put(AllMetrics.MetricName.MASTER_PENDING, PerformanceAnalyzerMetrics.sPendingTasksPath);
    metricPathMap.put(AllMetrics.MetricName.MOUNTED_PARTITION_METRICS,
        PerformanceAnalyzerMetrics.sMountedPartitionMetricsPath);
    metricPathMap.put(AllMetrics.MetricName.CLUSTER_APPLIER_SERVICE, PerformanceAnalyzerMetrics.sClusterApplierService);
    metricPathMap.put(AllMetrics.MetricName.ADMISSION_CONTROL_METRICS, PerformanceAnalyzerMetrics.sAdmissionControlMetricsPath);
    metricPathMap.put(AllMetrics.MetricName.SHARD_INDEXING_PRESSURE, PerformanceAnalyzerMetrics.sShardIndexingPressurePath);

    eventKeyToMetricNameMap = new HashMap<>();
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sCacheConfigPath, AllMetrics.MetricName.CACHE_CONFIG);
    eventKeyToMetricNameMap.put(
        PerformanceAnalyzerMetrics.sCircuitBreakerPath, AllMetrics.MetricName.CIRCUIT_BREAKER);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sHeapPath, AllMetrics.MetricName.HEAP_METRICS);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sDisksPath, AllMetrics.MetricName.DISK_METRICS);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sTCPPath, AllMetrics.MetricName.TCP_METRICS);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sIPPath, AllMetrics.MetricName.IP_METRICS);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sThreadPoolPath, AllMetrics.MetricName.THREAD_POOL);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sIndicesPath, AllMetrics.MetricName.SHARD_STATS);
    eventKeyToMetricNameMap.put(
    ...
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sAdmissionControlMetricsPath, AllMetrics.MetricName.ADMISSION_CONTROL_METRICS);
    eventKeyToMetricNameMap.put(PerformanceAnalyzerMetrics.sShardIndexingPressurePath, AllMetrics.MetricName.SHARD_INDEXING_PRESSURE);
    ...
    metricName2Property.put(
        ...
        new MetricProperties(
            ...
            createFileHandler(metricPathMap.get(AllMetrics.MetricName.CIRCUIT_BREAKER))));
    metricName2Property.put(
    ...
    metricName2Property.put(AllMetrics.MetricName.MOUNTED_PARTITION_METRICS,
        new MetricProperties(
            AllMetrics.DevicePartitionDimension.values(),
            AllMetrics.DevicePartitionValue.values(),
            createFileHandler(metricPathMap.get(AllMetrics.MetricName.MOUNTED_PARTITION_METRICS))
        ));
    metricName2Property.put(
            AllMetrics.MetricName.CLUSTER_APPLIER_SERVICE,
            new MetricProperties(
    ...
    metricName2Property.put(AllMetrics.MetricName.ADMISSION_CONTROL_METRICS,
        new MetricProperties(
            AllMetrics.AdmissionControlDimension.values(),
            AllMetrics.AdmissionControlValue.values(),
            createFileHandler(metricPathMap.get(AllMetrics.MetricName.ADMISSION_CONTROL_METRICS))
        ));
    metricName2Property.put(
        ...
        new MetricProperties(
            ...
            createFileHandler(metricPathMap.get(AllMetrics.MetricName.SHARD_INDEXING_PRESSURE))));
  }
