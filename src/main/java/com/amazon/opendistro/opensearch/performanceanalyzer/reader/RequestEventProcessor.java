...
public class RequestEventProcessor implements EventProcessor {
  ...
  private void emitStartMetric(String[] metricKeyPathElements, Map<String, String> keyValueMap) {
    ...
    long docCount =
        Long.parseLong(
            keyValueMap.computeIfAbsent(AllMetrics.ShardBulkMetric.ITEM_COUNT.toString(), k -> "0"));
    ...
    String primary = getPrimary(keyValueMap.get(AllMetrics.ShardBulkDimension.PRIMARY.toString()));
