...
public class PerformanceAnalyzerWebServerTest {
    ...
    public void tearDown() {
        ...
        if (oldPort != null) {
            PluginSettings.instance().overrideProperty(PluginSettings.WEBSERVICE_PORT_CONF_NAME, oldPort);
        } else {
            PluginSettings.instance().overrideProperty(PluginSettings.WEBSERVICE_PORT_CONF_NAME, "9600");
        }
