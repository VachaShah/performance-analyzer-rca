...
public class ModifyCacheMaxSizeActionTest {
  ...
  public void testIncreaseCapacity() {
    ...
    Map<ImpactVector.Dimension, ImpactVector.Impact> impact = fieldDataCacheIncrease.impact().get(node1).getImpact();
  ...
  public void testDecreaseCapacity() {
    ...
    Map<ImpactVector.Dimension, ImpactVector.Impact> impact = fieldDataCache.impact().get(node1).getImpact();
  ...
  public void testUnboundedFielddataCache() throws Exception {
    ...
    Assert.assertEquals(heapMaxSizeInBytes * CacheActionConfig.DEFAULT_FIELDDATA_CACHE_UPPER_BOUND,
  ...
  public void testSummary() {
    ...
    Assert.assertEquals(modifyCacheMaxSizeAction.getCacheType(), objectFromSummary.getCacheType());
  }

  private void assertNoImpact(NodeKey node, ModifyCacheMaxSizeAction modifyCacheSizeAction) {
    Map<ImpactVector.Dimension, ImpactVector.Impact> impact = modifyCacheSizeAction.impact().get(node).getImpact();
