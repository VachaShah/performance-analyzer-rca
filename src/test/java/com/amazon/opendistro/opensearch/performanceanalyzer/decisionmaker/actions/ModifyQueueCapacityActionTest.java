...
public class ModifyQueueCapacityActionTest {
  ...
  public void testIncreaseCapacity() {
    ...
    Assert.assertEquals(ModifyQueueCapacityAction.Builder.DEFAULT_COOL_OFF_PERIOD_IN_MILLIS,
    ...
    Map<ImpactVector.Dimension, ImpactVector.Impact> impact = modifyQueueCapacityAction.impact().get(node1).getImpact();
    Assert.assertEquals(ImpactVector.Impact.INCREASES_PRESSURE, impact.get(ImpactVector.Dimension.HEAP));
    Assert.assertEquals(ImpactVector.Impact.INCREASES_PRESSURE, impact.get(ImpactVector.Dimension.CPU));
    Assert.assertEquals(ImpactVector.Impact.INCREASES_PRESSURE, impact.get(ImpactVector.Dimension.NETWORK));
  ...
  public void testDecreaseCapacity() {
    ...
    assertEquals(ModifyQueueCapacityAction.Builder.DEFAULT_COOL_OFF_PERIOD_IN_MILLIS,
            modifyQueueCapacityAction.coolOffPeriodInMillis());
    Assert.assertEquals(ResourceEnum.SEARCH_THREADPOOL, modifyQueueCapacityAction.getThreadPool());
    assertEquals(1, modifyQueueCapacityAction.impactedNodes().size());

    Map<ImpactVector.Dimension, ImpactVector.Impact> impact = modifyQueueCapacityAction.impact().get(node1).getImpact();
    Assert.assertEquals(ImpactVector.Impact.DECREASES_PRESSURE, impact.get(ImpactVector.Dimension.HEAP));
    Assert.assertEquals(ImpactVector.Impact.DECREASES_PRESSURE, impact.get(ImpactVector.Dimension.CPU));
    Assert.assertEquals(ImpactVector.Impact.DECREASES_PRESSURE, impact.get(ImpactVector.Dimension.NETWORK));
    Assert.assertEquals(ImpactVector.Impact.NO_IMPACT, impact.get(ImpactVector.Dimension.RAM));
    Assert.assertEquals(ImpactVector.Impact.NO_IMPACT, impact.get(ImpactVector.Dimension.DISK));
  }
  ...
  public void testSummary() {
    ...
    Assert.assertEquals(modifyQueueCapacityAction.getThreadPool(), objectFromSummary.getThreadPool());
  }

  private void assertNoImpact(NodeKey node, ModifyQueueCapacityAction modifyQueueCapacityAction) {
    Map<ImpactVector.Dimension, ImpactVector.Impact> impact = modifyQueueCapacityAction.impact().get(node).getImpact();
    ...
    Assert.assertEquals(ImpactVector.Impact.NO_IMPACT, impact.get(ImpactVector.Dimension.NETWORK));
    Assert.assertEquals(ImpactVector.Impact.NO_IMPACT, impact.get(ImpactVector.Dimension.RAM));
    Assert.assertEquals(ImpactVector.Impact.NO_IMPACT, impact.get(ImpactVector.Dimension.DISK));
  }
}
