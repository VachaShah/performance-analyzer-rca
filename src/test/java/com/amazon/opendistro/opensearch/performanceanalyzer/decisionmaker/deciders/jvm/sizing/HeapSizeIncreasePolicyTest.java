...
public class HeapSizeIncreasePolicyTest {
  ...
  public void setUp() throws Exception {
    this.currentInstance = new InstanceDetails(new InstanceDetails.Id("current"), new InstanceDetails.Ip("2.3.4.5"), 0);
    initMocks(this);
    setupDataNodes();
    setupMockAppContext();
    setupMockRcaConf();
  ...
  private void setupDataNodes() {
    InstanceDetails dataNode1 = new InstanceDetails(new InstanceDetails.Id("node1"), new InstanceDetails.Ip("1.2.3.4"), 0);
    InstanceDetails dataNode2 = new InstanceDetails(new InstanceDetails.Id("node2"), new InstanceDetails.Ip("1.2.3.5"), 0);
    InstanceDetails dataNode3 = new InstanceDetails(new InstanceDetails.Id("node3"), new InstanceDetails.Ip("1.2.3.6"), 0);
