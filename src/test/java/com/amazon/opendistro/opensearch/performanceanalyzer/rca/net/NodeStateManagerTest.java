...
public class NodeStateManagerTest {
  ...
  public void testNewNodesAddedToCluster() {
    ...
    testNodeStateManager
        .updateSubscriptionState(TEST_NODE_1, new InstanceDetails.Id(TEST_HOST_1), SubscribeResponse.SubscriptionStatus.SUCCESS);
  ...
  public void testStaleNodesAndNewNodesAddedToCluster() {
    ...
    testNodeStateManager.updateReceiveTime(new InstanceDetails.Id(TEST_HOST_2), TEST_NODE_1, currentTime);
    testNodeStateManager.updateSubscriptionState(TEST_NODE_1, new InstanceDetails.Id(TEST_HOST_2), SubscribeResponse.SubscriptionStatus.SUCCESS);
