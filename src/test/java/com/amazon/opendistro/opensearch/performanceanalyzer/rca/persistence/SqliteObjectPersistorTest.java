...
public class SqliteObjectPersistorTest {
  ...
  public void persistTwoClassesWithSameName() throws Exception {
    ...
    com.amazon.opendistro.opensearch.performanceanalyzer.rca.persistence.pck2.TestPersist testPersist2 =
        new com.amazon.opendistro.opensearch.performanceanalyzer.rca.persistence.pck2.TestPersist();
