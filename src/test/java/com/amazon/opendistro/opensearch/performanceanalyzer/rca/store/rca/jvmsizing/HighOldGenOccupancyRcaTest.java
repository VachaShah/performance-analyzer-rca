...
public class HighOldGenOccupancyRcaTest {
  ...
  private final List<String> heapTableColumns = Arrays.asList(AllMetrics.HeapDimension.MEM_TYPE.toString(),
  ...
  private void setupMockHeapMetric(final Metric metric, final double val) {
    ...
    List<String> data = Arrays.asList(AllMetrics.GCType.OLD_GEN.toString(), valString,
  ...
  private void setupMockGcType(final String collector) {
    List<String> gcInfoTableColumns = Arrays.asList(AllMetrics.GCInfoDimension.MEMORY_POOL.toString(),
