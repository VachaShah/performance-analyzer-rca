...
public class AbstractReaderTests extends AbstractTests {
  ...
  protected String createHeapMetrics(AllMetrics.GCType name, long committed, long init, long max, long used) {
    return new HeapMetricsCollector.HeapStatus(name.toString(), committed, init, max, used).serialize();
  }

  protected String createHeapMetrics(AllMetrics.GCType name, long collectionCount, long collectionTime) {
    return new HeapMetricsCollector.HeapStatus(name.toString(), collectionCount, collectionTime).serialize();
  }
