  ...
  public void testStartEventOnly() {
    ...
    assertEquals(
        ...
        ((BigDecimal)
            ...
            .longValue());
    assertEquals(
        "urgent", rt.get(0).get(AllMetrics.MasterMetricDimensions.MASTER_TASK_PRIORITY.toString()));
    assertEquals(
        "create-index",
  ...
  public void testMultipleInsertOrderStartAndEndEvents() {
    ...
    assertEquals(
        ...
        ((BigDecimal)
            ...
            .longValue());
    assertEquals(
        "high", rt.get(1).get(AllMetrics.MasterMetricDimensions.MASTER_TASK_PRIORITY.toString()));
    assertEquals(
        "remapping", rt.get(1).get(AllMetrics.MasterMetricDimensions.MASTER_TASK_TYPE.toString()));
    assertEquals(
        "metadata2",
