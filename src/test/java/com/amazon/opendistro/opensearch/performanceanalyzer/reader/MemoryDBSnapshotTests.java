...
public class MemoryDBSnapshotTests extends AbstractReaderTests {
  ...
  public MemoryDBSnapshotTests() throws SQLException, ClassNotFoundException {
    ...
    fields[0] = DSL.field(AllMetrics.CircuitBreakerValue.CB_ESTIMATED_SIZE.toString(), Double.class);
    fields[1] = DSL.field(AllMetrics.CircuitBreakerValue.CB_CONFIGURED_SIZE.toString(), Double.class);
    fields[2] = DSL.field(AllMetrics.CircuitBreakerValue.CB_TRIPPED_EVENTS.toString(), Double.class);
  }
    ...
    Result<Record> resultRecord =
        circuitBreakerValuesSnap.fetchMetric(
            getDimensionEqCondition(
                AllMetrics.CircuitBreakerDimension.CB_TYPE, CircuitBreakerType.request.toString()),
            fields);
  ...
  public void testAlignWindow() throws Exception {
    ...
    Result<Record> res =
        circuitFinal.fetchMetric(
            getDimensionEqCondition(
                AllMetrics.CircuitBreakerDimension.CB_TYPE, CircuitBreakerType.fielddata.toString()),
            fields);
