...
public class NodeConfigCollectorTest {
  ...
  private void mockQueueFlowUnits(int writeQueueCapacity, int searchQueueCapacity) {
    MetricFlowUnit flowUnit = MetricFlowUnitTestHelper.createFlowUnit(
        Arrays.asList(AllMetrics.ThreadPoolDimension.THREAD_POOL_TYPE.toString(), MetricsDB.MAX),
        Arrays.asList(AllMetrics.ThreadPoolType.WRITE.toString(), String.valueOf(writeQueueCapacity)),
        Arrays.asList(AllMetrics.ThreadPoolType.SEARCH.toString(), String.valueOf(searchQueueCapacity))
    );
  ...
  private void mockHeapMaxSizeFlowUnits(int heapMaxSize, int oldGenMaxSize, int edenMaxSize, int survivorMaxSize) {
    MetricFlowUnit flowUnit =
        MetricFlowUnitTestHelper.createFlowUnit(
            ...
            Arrays.asList(AllMetrics.GCType.OLD_GEN.toString(), String.valueOf(oldGenMaxSize)),
            Arrays.asList(AllMetrics.GCType.EDEN.toString(), String.valueOf(edenMaxSize)),
            Arrays.asList(AllMetrics.GCType.SURVIVOR.toString(), String.valueOf(survivorMaxSize))
        );
