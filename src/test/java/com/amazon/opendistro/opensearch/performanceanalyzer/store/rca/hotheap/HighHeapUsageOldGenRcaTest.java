...
public class HighHeapUsageOldGenRcaTest {
  ...
  private void mockFlowUnits(double heapUsageVal, int gcEventVal) {
    ...
    gc_event.createTestFlowUnits(columnName, Arrays.asList(AllMetrics.GCType.TOT_FULL_GC.toString(), String.valueOf(gcEventVal)));
  }
  ...
  public void initTestHighHeapOldGenRca() {
    ...
    List<String> nodeStatColumnName = Arrays.asList(AllMetrics.CommonDimension.INDEX_NAME.toString(),
        AllMetrics.CommonDimension.SHARD_ID.toString(), MetricsDB.MAX);
    ...
    heap_Max.createTestFlowUnits(columnName, Arrays.asList(AllMetrics.GCType.HEAP.toString(), String.valueOf(100 * CONVERT_MEGABYTES_TO_BYTES)));
  }
