...
public class QueueRejectionRcaTest {
  ...
  private void mockFlowUnits(int writeRejectCnt, int searchRejectCnt) {
    threadPool_RejectedReqs.createTestFlowUnitsWithMultipleRows(columnName,
        Arrays.asList(
            Arrays.asList(AllMetrics.ThreadPoolType.WRITE.toString(), String.valueOf(writeRejectCnt)),
            Arrays.asList(AllMetrics.ThreadPoolType.SEARCH.toString(), String.valueOf(searchRejectCnt))
        )
    );
  }
  ...
  public void init() throws Exception {
    ...
    columnName = Arrays.asList(AllMetrics.ThreadPoolDimension.THREAD_POOL_TYPE.toString(), MetricsDB.MAX);
